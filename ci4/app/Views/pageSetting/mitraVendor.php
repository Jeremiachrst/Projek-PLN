...
<body>
                        ...
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nipeg">Initial Segmen:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" required>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Name Segmen:</label>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Mitra/Vendor Non PO I-Track';
    </script>
</body>
