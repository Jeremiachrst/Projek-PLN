...
<body>
        ...
        <div class="container main-container">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>ID Natural Account</th>
                        <th>Name Natural Account</th>
            ...
            <div class="modal fade" id="tambahDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Natural Account</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nipeg">ID Natural Account:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" required>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Name Natural Account:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
                                    <label for="lokasi">Jenis Anggaran :</label>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Natural Account';
    </script>
</body>
