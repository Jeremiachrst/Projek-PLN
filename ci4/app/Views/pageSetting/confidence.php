...
<body>
        ...
        <div class="container main-container">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Normal Confidence</th>
                        <th>Nama Confidence</th>
                        <th>Status</th>
                        <th>Opsi</th>
                    </tr>
                </thead>
            ...
            <div class="modal fade" id="tambahDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Confidence</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="lokasi">Proyeksi :</label>
                                    <select class="form-control" id="lokasi" name="lokasi" required>
                                        <option value="">Pilih Opsi Proyeksi</option>
                                        <option value="Jakarta">Aktif</option>
                                        <option value="Bandung">Non-Aktif</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="nipeg">Nama Proyeksi:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Nominal Confidence:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Name Confidence:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="editDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Data Natural Account</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nipeg">ID Confidence:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="lokasi">Proyeksi:</label>
                                ...
                                <div class="form-group">
                                    <label for="nipeg">Name Proyeksi:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nipeg">Nominal Confidence (%):</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" required>
                                </div>
                                <div class="form-group">
                                    <label for="nipeg">Name Confidence:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" required>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Confidence';
    </script>
</body>
