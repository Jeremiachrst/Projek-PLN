...
<body>
                        ...
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nama">Initial Proyeksi:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
                                    <label for="nama">Name Proyeksi:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nipeg">ID Proyeksi:</label>
                                    <input type="text" class="form-control" id="nipeg" name="nipeg" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nipeg">Initial Proyeksi:</label>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Proyeksi';
    </script>
</body>
