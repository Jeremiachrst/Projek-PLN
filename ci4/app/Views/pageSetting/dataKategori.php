...
<body>
                        ...
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="nipeg">Initial Kategori:</label>
                                ...
                                <div class="form-group">
                                    <label for="nama">Keterangan Kategori:</label>
                                    <input type="text" class="form-control" id="nama" name="nama" required>
                                </div>
                                <div class="form-group">
                                    <label for="lokasi">ID Jenis Anggaran:</label>
                                    <select class="form-control" id="lokasi" name="lokasi" required>
                                        <option value="">Pilih Opsi Jenis Anggaran</option>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Kategori';
    </script>
</body>
