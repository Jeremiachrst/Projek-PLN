...
<body>
                        ...
                        <div class="modal-body">
                            <form id="formEditData">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id-edit-data" name="ID" readonly>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Rutinitas';
    </script>
</body>
