...
<body>
        ...
        <div class="container main-container">
            ...
            <div class="modal fade" id="tambahDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Segmen Bisnis</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="formTambahData">
                                <div class="form-group">
                                    <label for="lokasi">Name Users:</label>
                                    <select class="form-control" id="lokasi" name="lokasi" required>
                                        <option value="">Pilih Name Users</option>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formTambahData">
                                ...
                                <div class="form-group">
                                    <label for="nipeg">Nama Rutinitas:</label>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Master Role';
    </script>
</body>
