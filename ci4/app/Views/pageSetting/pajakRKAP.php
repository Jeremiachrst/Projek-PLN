...
<body>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <a class="navbar-brand" id="navbarBrand" style="color:#fff">Setting Data Proyeksi</a>
        ...
        <div class="container main-container">
            ...
            <div class="modal fade" id="editDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit Pajak RKAP</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="formTambahData">
                                ...
                                <div class="form-group">
                                    <label for="nipeg">Nominal Pajak (%):</label>
    ...
    <script>
        ...
        document.getElementById('navbarBrand').textContent = 'Setting Data Pajak RKAP';
    </script>
</body>
